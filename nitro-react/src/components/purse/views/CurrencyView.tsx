...
export const CurrencyView: FC<CurrencyViewProps> = props =>
{
    ...
    {
        return (
            <Flex  justifyContent="end" pointer gap={ 1 } className="flexUi">
                <Text className='mt-1' truncate textEnd variant="white" grow>{ short ? LocalizeShortNumber(amount) : LocalizeFormattedNumber(amount) }</Text>
