  ...
  return (
    <>
      <div className="nitro">
        ...
        <Flex onClick={(event) => CreateLinkEvent("help/show")}>
          <i className="icon icon-helps" />
        </Flex>
        <Flex onClick={(event) => CreateLinkEvent("user-settings/toggle")}>
          <i className="icon icon-sett" />
        </Flex>
      ...
      {!hcDisabled && (
          <Flex className="flexUis" onClick={(event) => CreateLinkEvent("habboUI/open/hccenter")}>
            <Text className="mt-1" variant="white">{getClubText}</Text>
            <i className="icon icon-hc" />
