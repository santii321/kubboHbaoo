...
export const InfoStandWidgetUserView: FC<InfoStandWidgetUserViewProps> = props =>
{
    ...
    return (
        <Column className="nitro-infostand ">
            <Column overflow="visible" className="container-fluid paddingInfo" gap={ 1 }>
                <Column gap={ 1 }>
                    <Flex alignItems="center" className='contenidoInfo' justifyContent="between">
                        <Flex alignItems="center" gap={ 1 }>
                            <Text variant="white" className='contenidoText'>{ avatarInfo.name }</Text>
                        </Flex>
