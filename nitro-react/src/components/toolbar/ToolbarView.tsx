...
import { RoomToolsWidgetView } from "../room/widgets/room-tools/RoomToolsWidgetView";
...
export const ToolbarView: FC<{ isInRoom: boolean }> = (props) => {
  ...
  return (
    <>
      ...
      <div className="rooms py-2 px-2">
        {isInRoom && (
          <Base
            pointer
            className="navigation-item icon icon_goto_noroom"
      ...
      <Flex className="nitro-toolbar py-1 px-1">
        <Flex gap={2} alignItems="center" className="flexDisplay">
          ...
          <Flex alignItems="center" gap={2} className="barConte">
            <Base
              pointer
              className="navigation-item icon icon-roomsV2"
            ...
            <Base
              pointer
              className="navigation-item icon icon-icon_shop"
              onClick={(event) => CreateLinkEvent("catalog/toggle")}
            />
            <Base
              pointer
              className="navigation-item icon icon-icon_inventory"
            ...
            <Base
              pointer
              className="navigation-item icon icon-icon_friends"
